...
public class Edit_Vidchuttja extends BaseActivity {
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.edit_vidch);
	    ...
	    file_Name_Answ = file_Name.replaceAll(".vdc", ".ans");
	    file_Name_Audio = file_Name.replaceAll(".vdc", ".3gpp");
	    file_Name_Foto = file_Name.replaceAll(".vdc", ".jpg");
			...
			switch (view.getId())
			{
				...
				case R.id.saveAnsw:
					...
					question = quest.getText().toString();
		      		...
		      		Toast.makeText(Edit_Vidchuttja.this, "Збережено", Toast.LENGTH_LONG).show();
				...
				case R.id.listenAudio:
					...
					break;
				case R.id.editQuest:
					Toast.makeText(Edit_Vidchuttja.this, "Введіть текст запитання", Toast.LENGTH_LONG).show();
					
					/*AlertDialog.Builder*/ alert = new AlertDialog.Builder(Edit_Vidchuttja.this);
					...
					alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
						  ...
						  Toast.makeText(Edit_Vidchuttja.this, "Ви ввели: " + question, Toast.LENGTH_LONG).show();
						  quest.setText(question);
						  }
						});
				...
				case R.id.editAnsw:
					...
					Toast.makeText(Edit_Vidchuttja.this, "Введіть текст відповіді", Toast.LENGTH_LONG).show();
					...
					alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
						  ...
						  // Получили значение введенных данных!
						  Toast.makeText(Edit_Vidchuttja.this, "Ви ввели: " + newAnsw, Toast.LENGTH_LONG).show();
						  /*answ.setText(newAnsw);*/
						  }
						});
				...
				case R.id.showFoto:
					...
					if ( ff.exists() )
					{
						/*Intent*/ intent = new Intent(Edit_Vidchuttja.this, Your_quest_SHOW_foto.class); 
						intent.putExtra("fotoFile", file_Path + "/" + file_Name_Foto);
						// intent.putExtra("path", MO_io.filePath);
						startActivity(intent);
					}
					else
						Toast.makeText(Edit_Vidchuttja.this, "Немає фото", Toast.LENGTH_LONG).show();
	...
	public void onActivityResult (int requestCode, int resultCode, Intent data) {
		if (requestCode == PHOTO_INTENT_REQUEST_CODE) {
			if (resultCode == RESULT_OK) {
				Toast.makeText(Edit_Vidchuttja.this, "Готово", Toast.LENGTH_LONG).show();
				//mImage.setImageURI(mUri);
			}
			else if (resultCode == RESULT_CANCELED) 
				Toast.makeText(Edit_Vidchuttja.this, "Відмінено", Toast.LENGTH_LONG).show();
			else 
				Toast.makeText(Edit_Vidchuttja.this, "Помилка", Toast.LENGTH_LONG).show();
		}
	}	
	...
	public String dlgGetString (String title, String msg)
	{
		...
		alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				// Получили значение введенных данных!
				Toast.makeText(Edit_Vidchuttja.this, "Ви ввели: " + fromDialog, Toast.LENGTH_LONG).show();
			}
		});
...
// /////////////  playStart  (НАЧАЛО) /////////////////////////////////////////////////////	
	  public void playStart(View v) {
	    try {
	      ...
	      {Toast.makeText(Edit_Vidchuttja.this, "Немає запису", Toast.LENGTH_LONG).show(); return; }
