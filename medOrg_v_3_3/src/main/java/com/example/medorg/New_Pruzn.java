...
public class New_Pruzn extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void Save_quest(View view)  // Это - обработчик
	 {
		 ...
		 try {
		      switch (view.getId())
		      {
		      	case R.id.btn_Save:
		      		...
		      		String f_Name = "bb" + String.valueOf(System.currentTimeMillis()) + ".prz";
		 ...
		 Toast.makeText(New_Pruzn.this, "Збережено", Toast.LENGTH_LONG).show();
