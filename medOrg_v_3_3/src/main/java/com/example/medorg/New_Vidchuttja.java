...
public class New_Vidchuttja extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_vidch);
	}
	 ...
	 public void Save_quest(View view)  // Это - обработчик
	 {
		 ...
		 try {
		      switch (view.getId())
		      {
		      	case R.id.btn_Save:
		      		...
		      		String f_Name = "sd" + String.valueOf(System.currentTimeMillis()) + ".vdc";
		 ...
		 Toast.makeText(New_Vidchuttja.this, "Збережено", Toast.LENGTH_LONG).show();
	 } 
