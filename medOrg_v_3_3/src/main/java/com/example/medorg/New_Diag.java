...
public class New_Diag extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_diag);
	}
	 ...
	 public void Save_quest(View view)  // Это - обработчик
	 {
		 ...
		 try {
		      switch (view.getId())
		      {
		      	case R.id.btn_Save:
		      		...
		      		String f_Name = "act" + String.valueOf(System.currentTimeMillis()) + ".dgn";
		 ...
		 Toast.makeText(New_Diag.this, "Збережено", Toast.LENGTH_LONG).show();
