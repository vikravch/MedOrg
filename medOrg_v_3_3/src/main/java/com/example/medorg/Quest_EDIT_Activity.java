...
public class Quest_EDIT_Activity extends BaseActivity {
...
/**/
		MO_io =  new MO_io_class("MO_QS", ".qst");		//  Таких файлов не бывает !!!!
...
/*
	 ...
	 intent.putExtra("checked_number", checked_number);	  	// Количество выбранных вопросов в группе
...
//		int 	checked_number = intent.getIntExtra("checked_number",0);
	    ...
	    quest.setText(Checked_quests[0]);	//  Вопрос - на экран
...
/*
				...
				*/
				case R.id.editAnswStandard:		// editAnswStandard - не кнопка, а EditText
					...
					// AlertDialog.Builder 
					alert = new AlertDialog.Builder(Quest_EDIT_Activity.this);
					...
					alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
						  ...
						  // Получили значение введенных данных!
						  Toast.makeText(Quest_EDIT_Activity.this, "Ви ввели: " + newAnsw, Toast.LENGTH_LONG).show();
						  answ.setText(newAnsw);
	...
	public void onActivityResult (int requestCode, int resultCode, Intent data) {
		if (requestCode == PHOTO_INTENT_REQUEST_CODE) {
			if (resultCode == RESULT_OK) {
				Toast.makeText(Quest_EDIT_Activity.this, "Готово", Toast.LENGTH_LONG).show();
				//mImage.setImageURI(mUri);
			}
			else if (resultCode == RESULT_CANCELED) 
				Toast.makeText(Quest_EDIT_Activity.this, "Відмінено", Toast.LENGTH_LONG).show();
			else 
				Toast.makeText(Quest_EDIT_Activity.this, "Помилка", Toast.LENGTH_LONG).show();
		}
	}	
...
// /////////////  dlgGetString  (НАЧАЛО) //////////////////////////////////////////////////
	...
	{
		//final String val;
		AlertDialog.Builder alert = new AlertDialog.Builder(Quest_EDIT_Activity.this);
		...
		alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				// Получили значение введенных данных!
				Toast.makeText(Quest_EDIT_Activity.this, "Ви ввели: " + fromDialog, Toast.LENGTH_LONG).show();
			}
		});
...
// /////////////  playStart  (НАЧАЛО) /////////////////////////////////////////////////////	
	  public void playStart(View v) {
	    try {
	      ...
	      {Toast.makeText(Quest_EDIT_Activity.this, "Немає запису", Toast.LENGTH_LONG).show(); return; }
		                	...
		                	{	
		                		...
		                		{	
		                			...
		                			{	
	                			        ...
	                			        anim = AnimationUtils.loadAnimation(Quest_EDIT_Activity.this, R.anim.anim_left_swipe_into_standard_quest_edit);
	                			        rl.startAnimation(anim);
	                			        if( N_quest == (Checked_quest_num.length-1) )
	                			        {
	                			        	N_quest =  0;
	                			        }
	                			        else
		                				...
		                				{	
		                					...
		                					*/		                					
		                			        ...
		                			        anim = AnimationUtils.loadAnimation(Quest_EDIT_Activity.this, R.anim.anim_right_swipe_into_standard_quest_edit);
		                			        rl.startAnimation(anim);
											...
											*/
		                			        if( N_quest == 0 )
		                			        {
		                			        	N_quest =  Checked_quest_num.length-1;
		                			        }
		                			        else
		                			        {
		                			        	N_quest--;
 ...
 */  	    	
        ...
        btn_showFoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				if ( ff.exists() )
				{
					intent = new Intent(Quest_EDIT_Activity.this, Your_quest_SHOW_foto.class); 
					intent.putExtra("fotoFile", file_Path + "/" + file_Name_Foto);
					// intent.putExtra("path", MO_io.filePath);
					startActivity(intent);
				}
				else
					Toast.makeText(Quest_EDIT_Activity.this, "Немає фото", Toast.LENGTH_LONG).show();
			}
    	} );
