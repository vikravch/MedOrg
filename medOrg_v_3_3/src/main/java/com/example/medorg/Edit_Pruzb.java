...
public class Edit_Pruzb extends BaseActivity {
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    file_Name_Answ = file_Name.replaceAll(".prz", ".ans");
	    file_Name_Audio = file_Name.replaceAll(".prz", ".3gpp");
	    file_Name_Foto = file_Name.replaceAll(".prz", ".jpg");
			...
			switch (view.getId())
			{
				...
				case R.id.saveAnsw:
					...
					question = quest.getText().toString();
		      		...
		      		Toast.makeText(Edit_Pruzb.this, "Збережено", Toast.LENGTH_LONG).show();
				...
				case R.id.listenAudio:
					...
					{
						in1.playStart(view, file_Path, file_Name_Audio, Edit_Pruzb.this);
						btnAudio.setText("СТОП");
						btnAudio.setBackgroundResource(R.drawable.btn_stop);
					}
					break;
				case R.id.editQuest:
					Toast.makeText(Edit_Pruzb.this, "Введіть текст запитання", Toast.LENGTH_LONG).show();
					
					/*AlertDialog.Builder*/ alert = new AlertDialog.Builder(Edit_Pruzb.this);
					...
					alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
						  ...
						  Toast.makeText(Edit_Pruzb.this, "Ви ввели: " + question, Toast.LENGTH_LONG).show();
						  quest.setText(question);
						  }
						});
				...
				case R.id.editAnsw:
					...
					Toast.makeText(Edit_Pruzb.this, "Введіть текст відповіді", Toast.LENGTH_LONG).show();
					...
					alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
						  ...
						  // Получили значение введенных данных!
						  Toast.makeText(Edit_Pruzb.this, "Ви ввели: " + newAnsw, Toast.LENGTH_LONG).show();
						  /*answ.setText(newAnsw);*/
						  }
						});
				...
				case R.id.showFoto:
					...
					if ( ff.exists() )
					{
						/*Intent*/ intent = new Intent(Edit_Pruzb.this, Your_quest_SHOW_foto.class); 
						intent.putExtra("fotoFile", file_Path + "/" + file_Name_Foto);
						// intent.putExtra("path", MO_io.filePath);
						startActivity(intent);
					}
					else
						Toast.makeText(Edit_Pruzb.this, "Немає фото", Toast.LENGTH_LONG).show();
	...
	// /////////////  playStart  (НАЧАЛО) /////////////////////////////////////////////////////	
		  public void playStart(View v) {
		    try {
		      ...
		      {Toast.makeText(Edit_Pruzb.this, "Немає запису", Toast.LENGTH_LONG).show(); return; }
