...
public class Params {
    ...
    public static final Uri OPROS_URI = Uri.parse("content://"+AUTORITY+"/"+TYPE_OPROS);
    ...
    //table opros in DB
    public static final String OPROS_TABLE_NAME = "opros";
    public static final String OPROS_TYPE = "type";
    public static final String OPROS_DATE = "date";
    public static final String OPROS_WHO = "who";
    public static final String OPROS_RESULT = "result";
