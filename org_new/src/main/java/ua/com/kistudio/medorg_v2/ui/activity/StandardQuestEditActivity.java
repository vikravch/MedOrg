...
import ua.com.kistudio.medorg_v2.util.SwipeDetector;
import ua.com.kistudio.medorg_v2.model.MO_io_class;

public class StandardQuestEditActivity extends BaseActivity {
...
*/			
			...
			Log.i("FileNames_List[" + N_quest + "]", file_Name);
...
*/
		...
		Log.i("Жесты!!!","В \"onCreate()\" методе: Создан объект gestureDetector");

		linLayout_QuestStandard = (LinearLayout)findViewById(R.id.LinearLayout_QuestStandard);	// LinearLayout_QuestStandard"
		
		if( linLayout_QuestStandard == null ) {Log.i("В \"onCreate()\" методе:!!!", "  Не удалось создать объект View view = findViewById();");}
		else Log.i("Жесты!!!","В \"onCreate()\" методе: Создан объект linLayout_QuestStandard = findViewById();");
		...
		Log.i("Жесты!!!", "В \"onCreate()\" методе: Установлен обработчик linLayout_QuestStandard.setOnTouchListener()");

		linLayout_QuestStandard.setOnClickListener(new OnClickListener() {
		        public void onClick(View arg0) {
		        	Log.i("Жесты!!!", "В \"OnClickListener()\"");
...
/*
				...
				*/
				case R.id.editAnswStandard:		// editAnswStandard - не кнопка, а EditText
					...
					// AlertDialog.Builder 
					alert = new AlertDialog.Builder(StandardQuestEditActivity.this);
					...
					alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
						  ...
						  // Получили значение введенных данных!
						  Toast.makeText(StandardQuestEditActivity.this, "Ви ввели: " + newAnsw, Toast.LENGTH_LONG).show();
						  answ.setText(newAnsw);
						    ...
						    if (answFile.exists()) { answFile.delete(); }
				      		try {
				      			...
				      			// закрываем поток
				      			bw.close();
				      			Log.i("Ответ записан: " , "Файл: " + answFile.getAbsolutePath() + " " + newAnsw);
				      	    	} catch (IOException e) {
				      	    		e.printStackTrace();
				      	    	}
	...
	public void onActivityResult (int requestCode, int resultCode, Intent data) {
		if (requestCode == PHOTO_INTENT_REQUEST_CODE) {
			if (resultCode == RESULT_OK) {
				Toast.makeText(StandardQuestEditActivity.this, "Готово", Toast.LENGTH_LONG).show();
				//mImage.setImageURI(mUri);
			}
			else if (resultCode == RESULT_CANCELED) 
				Toast.makeText(StandardQuestEditActivity.this, "Відмінено", Toast.LENGTH_LONG).show();
			else 
				Toast.makeText(StandardQuestEditActivity.this, "Помилка", Toast.LENGTH_LONG).show();
		}
	}	
...
// /////////////  dlgGetString  (НАЧАЛО) //////////////////////////////////////////////////
	...
	{
		//final String val;
		AlertDialog.Builder alert = new AlertDialog.Builder(StandardQuestEditActivity.this);
		...
		alert.setPositiveButton("ОК", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				// Получили значение введенных данных!
				Toast.makeText(StandardQuestEditActivity.this, "Ви ввели: " + fromDialog, Toast.LENGTH_LONG).show();
			}
		});
...
// /////////////  playStart  (НАЧАЛО) /////////////////////////////////////////////////////	
	  public void playStart(View v) {
	    try {
	      ...
	      {Toast.makeText(StandardQuestEditActivity.this, "Немає запису", Toast.LENGTH_LONG).show(); return; }
		                	...
		                	{	
		                		...
		                		{	
		                			...
		                			{	
	                			        ...
	                			        anim = AnimationUtils.loadAnimation(StandardQuestEditActivity.this, R.anim.anim_left_swipe_into_standard_quest_edit);
		                				...
		                				{	
		                					...
		                					*/		                					
		                			        ...
		                			        anim = AnimationUtils.loadAnimation(StandardQuestEditActivity.this, R.anim.anim_right_swipe_into_standard_quest_edit);
		                			        rl.startAnimation(anim);
 ...
 */  	
        ...
        btn_showFoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				if ( ff.exists() )
				{
					/*intent = new Intent(StandardQuestEditActivity.this, Your_quest_SHOW_foto.class);
					intent.putExtra("fotoFile", file_Path + "/" + file_Name_Foto);
					// intent.putExtra("path", MO_io.filePath);
					startActivity(intent);*/
				}
				else
					Toast.makeText(StandardQuestEditActivity.this, "Немає фото", Toast.LENGTH_LONG).show();
			}
    	} );
